...
var commands = module.exports = {
  ...
  // check that an apk del command has --no-network flag
  apkdel_nonetwork: function (apkaddCommand) {
    return command_parser.command_has_flag(apkaddCommand, '--no-network');
  },
